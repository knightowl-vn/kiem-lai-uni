...
class ReaderReadingHistoryEndToEndIntegrationTest {
    ...
    static void configureDataSource(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.datasource.username", ReaderReadingHistoryEndToEndIntegrationTest::resolveUser);
        registry.add("spring.datasource.password", ReaderReadingHistoryEndToEndIntegrationTest::resolvePassword);
    }
