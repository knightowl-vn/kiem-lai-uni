...
class PublicNovelLandingInvalidationCoordinatorTest {

    @Mock
    private PublicNovelLandingCachePort cache;

    @Test
    void invalidatesOnlyAfterSuccessfulCommit() {
        PublicNovelLandingInvalidationCoordinator coordinator =
                new PublicNovelLandingInvalidationCoordinator(cache);
