...
class VolumeJpaOptimisticLockingIntegrationTest {
    ...
    static void configureDataSource(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.datasource.username", VolumeJpaOptimisticLockingIntegrationTest::resolveUser);
        registry.add("spring.datasource.password", VolumeJpaOptimisticLockingIntegrationTest::resolvePassword);
