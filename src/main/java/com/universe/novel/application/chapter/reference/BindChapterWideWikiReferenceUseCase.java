...
@Service
@Transactional
public class BindChapterWideWikiReferenceUseCase {
    ...
    public ChapterWikiReferenceItemDTO execute(BindChapterWideWikiReferenceCommand command) {
        ...
        Optional<ChapterWikiReference> existingOpt = referenceRepositoryPort
                .findByChapterIdAndNormalizedTermAndOccurrenceIndex(command.chapterId(), normalizedTerm, 0);
        ...
        if (existingOpt.isPresent()) {
            ...
            referenceToSave = ChapterWikiReference.createChapterWide(
                    refId,
                    command.chapterId(),
                    displayTerm,
