...
public class CommonMarkChapterNarrationBlockExtractor implements ChapterNarrationBlockExtractorPort {
    ...
    public CommonMarkChapterNarrationBlockExtractor() {
    ...
    private void collectSemanticBlocks(Node node, List<String> blocks) {
    ...
    private void collectTableBlocks(Node tableBlock, List<String> blocks) {
