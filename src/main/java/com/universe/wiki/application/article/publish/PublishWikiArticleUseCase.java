...
@Service
public class PublishWikiArticleUseCase {
    ...
    public PublishWikiArticleUseCase(
    ...
    public WikiArticleDTO execute(
        ...
        Objects.requireNonNull(
                command,
                "Publish wiki article command không được để trống."
        );
    ...
    private void savePublishRevision(
            WikiArticle article,
            String editSummary
    ) {
        UUID revisionId =
